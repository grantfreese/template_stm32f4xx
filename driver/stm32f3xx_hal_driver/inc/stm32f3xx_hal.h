...
/* Includes ------------------------------------------------------------------*/
#include "platform/stm32f3xx_hal_conf.h"
...
#define HAL_REMAPDMA_ADC24_DMA2_CH34                                                          \
    (0x00000100U) /*!< ADC24 DMA remap (STM32F303xB/C/E, STM32F358xx and STM32F398xx devices) \
...
#define HAL_REMAPDMA_TIM17_DMA1_CH7            \
...
#define HAL_REMAPDMA_TIM6_DAC1_CH1_DMA1_CH3                                                                   \
    (0x00002000U) /*!< TIM6 and DAC channel1 DMA remap (STM32F303xB/C/E, STM32F358xx and STM32F398xx devices) \
                                1: Remap (TIM6_UP and DAC_CH1 DMA requests mapped on DMA1 channel 3) */
#define HAL_REMAPDMA_TIM7_DAC1_CH2_DMA1_CH4                                                                   \
    (0x00004000U) /*!< TIM7 and DAC channel2 DMA remap (STM32F303xB/C/E, STM32F358xx and STM32F398xx devices) \
...
#define HAL_REMAPDMA_TIM18_DAC2_CH1_DMA1_CH5                                  \
    (0x00008000U) /*!< DAC2 channel1 DMA remap (STM32F303x4/6/8 devices only) \
                                1: Remap (DAC2_CH1 DMA requests mapped on DMA1 channel 5) */
...
#define HAL_REMAPDMA_SPI1_RX_DMA1_CH2                                   \
    (0x01000003U) /*!< SPI1_RX DMA remap (STM32F303x4/6/8 devices only) \
                                11: Map on DMA1 channel 2 */
#define HAL_REMAPDMA_SPI1_RX_DMA1_CH4                                   \
    (0x01000001U) /*!< SPI1_RX DMA remap (STM32F303x4/6/8 devices only) \
                                01: Map on DMA1 channel 4 */
#define HAL_REMAPDMA_SPI1_RX_DMA1_CH6                                   \
    (0x01000002U) /*!< SPI1_RX DMA remap (STM32F303x4/6/8 devices only) \
                                10: Map on DMA1 channel 6 */
#define HAL_REMAPDMA_SPI1_TX_DMA1_CH3                                   \
    (0x0100000CU) /*!< SPI1_TX DMA remap (STM32F303x4/6/8 devices only) \
                                11: Map on DMA1 channel 3 */
#define HAL_REMAPDMA_SPI1_TX_DMA1_CH5                                   \
    (0x01000004U) /*!< SPI1_TX DMA remap (STM32F303x4/6/8 devices only) \
                                01: Map on DMA1 channel 5 */
#define HAL_REMAPDMA_SPI1_TX_DMA1_CH7                                   \
    (0x01000008U) /*!< SPI1_TX DMA remap (STM32F303x4/6/8 devices only) \
                                10: Map on DMA1 channel 7 */
#define HAL_REMAPDMA_I2C1_RX_DMA1_CH7                                   \
    (0x01000030U) /*!< I2C1_RX DMA remap (STM32F303x4/6/8 devices only) \
                                11: Map on DMA1 channel 7 */
#define HAL_REMAPDMA_I2C1_RX_DMA1_CH3                                   \
    (0x01000010U) /*!< I2C1_RX DMA remap (STM32F303x4/6/8 devices only) \
                                01: Map on DMA1 channel 3 */
#define HAL_REMAPDMA_I2C1_RX_DMA1_CH5                                   \
    (0x01000020U) /*!< I2C1_RX DMA remap (STM32F303x4/6/8 devices only) \
                                10: Map on DMA1 channel 5 */
#define HAL_REMAPDMA_I2C1_TX_DMA1_CH6                                   \
    (0x010000C0U) /*!< I2C1_TX DMA remap (STM32F303x4/6/8 devices only) \
                                11: Map on DMA1 channel 6 */
#define HAL_REMAPDMA_I2C1_TX_DMA1_CH2                                   \
    (0x01000040U) /*!< I2C1_TX DMA remap (STM32F303x4/6/8 devices only) \
                                01: Map on DMA1 channel 2 */
#define HAL_REMAPDMA_I2C1_TX_DMA1_CH4                                   \
    (0x01000080U) /*!< I2C1_TX DMA remap (STM32F303x4/6/8 devices only) \
                                10: Map on DMA1 channel 4 */
#define HAL_REMAPDMA_ADC2_DMA1_CH2                          \
    (0x01000100U) /*!< ADC2 DMA remap                       \
                                x0: No remap (ADC2 on DMA2) \
                                10: Map on DMA1 channel 2 */
#define HAL_REMAPDMA_ADC2_DMA1_CH4    \
    (0x01000300U) /*!< ADC2 DMA remap \
...
#define HAL_REMAPTRIGGER_DAC1_TRIG                                                                  \
    (0x00000080U) /*!< DAC trigger remap (when TSEL = 001 on STM32F303xB/C and STM32F358xx devices) \
...
#define HAL_REMAP_CFGR3_MASK (0x01000000U)
#endif
#define HAL_REMAPTRIGGER_DAC1_TRIG3                                  \
    (0x01010000U) /*!< DAC1_CH1 / DAC1_CH2 Trigger remap             \
                                0: Remap (DAC trigger is TIM15_TRGO) \
                                1: Remap (DAC trigger is HRTIM1_DAC1_TRIG1) */
#define HAL_REMAPTRIGGER_DAC1_TRIG5                      \
    (0x01020000U) /*!< DAC1_CH1 / DAC1_CH2 Trigger remap \
                                0: No remap              \
 ...
 * @{
 */
#define HAL_REMAPADCTRIGGER_ADC12_EXT2                                           \
    SYSCFG_CFGR4_ADC12_EXT2_RMP /*!< Input trigger of ADC12 regular channel EXT2 \
                                     0: No remap (TIM1_CC3)                      \
                                     1: Remap (TIM20_TRGO) */
#define HAL_REMAPADCTRIGGER_ADC12_EXT3                                           \
    SYSCFG_CFGR4_ADC12_EXT3_RMP /*!< Input trigger of ADC12 regular channel EXT3 \
                                     0: No remap (TIM2_CC2)                      \
                                     1: Remap (TIM20_TRGO2) */
#define HAL_REMAPADCTRIGGER_ADC12_EXT5                                           \
    SYSCFG_CFGR4_ADC12_EXT5_RMP /*!< Input trigger of ADC12 regular channel EXT5 \
                                     0: No remap (TIM4_CC4)                      \
                                     1: Remap (TIM20_CC1) */
#define HAL_REMAPADCTRIGGER_ADC12_EXT13                                            \
    SYSCFG_CFGR4_ADC12_EXT13_RMP /*!< Input trigger of ADC12 regular channel EXT13 \
                                      0: No remap (TIM6_TRGO)                      \
                                      1: Remap (TIM20_CC2) */
#define HAL_REMAPADCTRIGGER_ADC12_EXT15                                            \
    SYSCFG_CFGR4_ADC12_EXT15_RMP /*!< Input trigger of ADC12 regular channel EXT15 \
                                      0: No remap (TIM3_CC4)                       \
                                      1: Remap (TIM20_CC3) */
#define HAL_REMAPADCTRIGGER_ADC12_JEXT3                                             \
    SYSCFG_CFGR4_ADC12_JEXT3_RMP /*!< Input trigger of ADC12 injected channel JEXT3 \
                                      0: No remap (TIM2_CC1)                        \
                                      1: Remap (TIM20_TRGO) */
#define HAL_REMAPADCTRIGGER_ADC12_JEXT6                                             \
    SYSCFG_CFGR4_ADC12_JEXT6_RMP /*!< Input trigger of ADC12 injected channel JEXT6 \
                                      0: No remap (EXTI line 15)                    \
                                      1: Remap (TIM20_TRGO2) */
#define HAL_REMAPADCTRIGGER_ADC12_JEXT13                                              \
    SYSCFG_CFGR4_ADC12_JEXT13_RMP /*!< Input trigger of ADC12 injected channel JEXT13 \
                                      0: No remap (TIM3_CC1)                          \
                                      1: Remap (TIM20_CC4) */
...
#define HAL_REMAPADCTRIGGER_ADC34_EXT5                                           \
    SYSCFG_CFGR4_ADC34_EXT5_RMP /*!< Input trigger of ADC34 regular channel EXT5 \
                                     ...
                                     1: Remap (TIM20_TRGO) */
#define HAL_REMAPADCTRIGGER_ADC34_EXT6                                           \
    SYSCFG_CFGR4_ADC34_EXT6_RMP /*!< Input trigger of ADC34 regular channel EXT6 \
                                     0: No remap (TIM4_CC1)                      \
                                     1: Remap (TIM20_TRGO2) */
#define HAL_REMAPADCTRIGGER_ADC34_EXT15                                            \
    SYSCFG_CFGR4_ADC34_EXT15_RMP /*!< Input trigger of ADC34 regular channel EXT15 \
                                      0: No remap (TIM2_CC1)                       \
                                      1: Remap (TIM20_CC1) */
#define HAL_REMAPADCTRIGGER_ADC34_JEXT5                                             \
    SYSCFG_CFGR4_ADC34_JEXT5_RMP /*!< Input trigger of ADC34 injected channel JEXT5 \
                                      0: No remap (TIM4_CC3)                        \
                                      1: Remap (TIM20_TRGO) */
#define HAL_REMAPADCTRIGGER_ADC34_JEXT11                                              \
    SYSCFG_CFGR4_ADC34_JEXT11_RMP /*!< Input trigger of ADC34 injected channel JEXT11 \
                                       0: No remap (TIM1_CC3)                         \
                                       1: Remap (TIM20_TRGO2) */
#define HAL_REMAPADCTRIGGER_ADC34_JEXT14                                              \
    SYSCFG_CFGR4_ADC34_JEXT14_RMP /*!< Input trigger of ADC34 injected channel JEXT14 \
...
#define __HAL_REMAPENCODER_TIM2()                      \
    do                                                 \
    {                                                  \
        SYSCFG->CFGR1 &= ~(SYSCFG_CFGR1_ENCODER_MODE); \
...
/** @brief  Encoder mode : TIM4 IC1 and TIM4 IC2 are connected to TIM15 IC1 and TIM15 IC2 (STM32F303xB/C and STM32F358xx
 * devices)
 */
...
#define __HAL_DMA_REMAP_CHANNEL_ENABLE(__DMA_REMAP__)                                                            \
    ...
    {                                                                                                            \
        ...
        (((__DMA_REMAP__) & HAL_REMAP_CFGR3_MASK) ? (SYSCFG->CFGR3 |= ((__DMA_REMAP__) & ~HAL_REMAP_CFGR3_MASK)) \
...
#define __HAL_SYSCFG_INTERRUPT_ENABLE(__INTERRUPT__)            \
    do                                                          \
    {                                                           \
        assert_param(IS_HAL_SYSCFG_INTERRUPT((__INTERRUPT__))); \
 ...
 *         Enables and locks the PVD connection with Timer1/8/15/16/17 Break Input, , as well as the PVDE and PLS[2:0]
...
#define __HAL_REMAPTRIGGER_ENABLE(__TRIGGER_REMAP__)                            \
    do                                                                          \
    {                                                                           \
        assert_param(IS_HAL_REMAPTRIGGER((__TRIGGER_REMAP__)));                 \
...
#define __HAL_REMAPADCTRIGGER_ENABLE(__ADCTRIGGER_REMAP__)            \
    do                                                                \
    {                                                                 \
        assert_param(IS_HAL_REMAPADCTRIGGER((__ADCTRIGGER_REMAP__))); \
...
#define __HAL_SYSCFG_SRAM_WRP_ENABLE(__PAGE_WP__)           \
    do                                                      \
    {                                                       \
        assert_param(IS_HAL_SYSCFG_WP_PAGE((__PAGE_WP__))); \
