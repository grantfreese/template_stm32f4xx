...
/**
 * Enable or disable autocomplete (live ghost-text suggestions and TAB/Enter
 * expansion). When disabled, the CLI emits no save-cursor / restore-cursor
 * escape sequences during typing, which makes the output trivial to parse
 * for automated tools.
 * @param cli
 * @param enabled  true to enable autocomplete, false to disable
 */
