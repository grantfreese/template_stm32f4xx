...
## T6: Dead-code audit of src/ and driver/
**Status**: `to-do`
...
with no includers (T5 wires it up), the ADC1 debug streamer had no producer (B1), src/version.h.in appears
...
## T5: 'status' CLI: task loop stats and stack usage
**Status**: `to-do`
